...
openssl ocsp -index index -CA certs/ca-cert.pem -rsigner certs/ocsp.cert.pem -rkey private/ocsp.key.pem -no_nonce -ndays 1 -reqin client-request.der -respout ../ocsp-client-good.der
printf "Done.\r\n"
...
openssl ocsp -index index -CA certs/ca-cert.pem -rsigner certs/ocsp.cert.pem -rkey private/ocsp.key.pem -no_nonce -ndays 1 -reqin client-request.der -respout ../ocsp-client-revoked.der
printf "Done.\r\n"
